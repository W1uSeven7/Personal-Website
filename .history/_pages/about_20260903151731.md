...
我持续关注 **AI 技术与产品创新**，对大模型、Agent、AI Native 产品及出海业务保持浓厚兴趣。我期待的不只是“为产品加入 AI 功能”，更希望探索如何将 AI 真正融入用户场景，解决实际问题，并为不同市场的用户创造更自然、高效的产品体验。

我也喜欢用 AI 把想法快速变成产品。借助 Codex、Cursor 等工具，通过 **Vibe Coding** 快速完成可交互 Demo 搭建、功能验证与用户测试。我希望加入重视 AI 创新与用户价值的团队，参与并推动产品从 **想法验证到 0→1 落地**的全过程。
